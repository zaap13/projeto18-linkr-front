import { HeaderStyle, InputContainer, LogoutContainer, SearchButton, SearchContainer, SearchUserList, UserAlreadySearched } from "./HeaderStyle";
...
export default function Header() {
    ...
    return(
        <HeaderStyle>
            ...
            <SearchContainer>
                <InputContainer>
                    <input type="text" placeholder="Search for people" onClick={() => setDisplay(!display)} />
                    <SearchButton type="submit"> 
                        <GoSearch size="small" color="#C6C6C6" />
                    </SearchButton>
                </InputContainer>
                <SearchUserList display={usersList.length !== 0 && display === true ? "flex" : "none"}>
                    <UserAlreadySearched>
